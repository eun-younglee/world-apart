    ...
    >
      ...
      <div className="z-10 flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-2 animate-fade-in">
          <span
            className={clsx(
              "text-xl sm:text-3xl font-bold tracking-[0.3em] uppercase",
          ...
          <h1
            className={clsx(
              "text-3xl sm:text-6xl md:text-8xl font-black tracking-tight",
        ...
        <div className="relative py-4 animate-fade-in-delayed">
          <span
            className={clsx(
              "relative text-4xl sm:text-8xl leading-none font-black tracking-tighter tabular-nums",
              backgroundColor === "bg-blue-100" ? "text-black" : "text-white"
            )}
          >
            {time}
        ...
        <div
          className={clsx(
            ...
            "px-6 py-3 sm:px-10 sm:py-5 shadow-2xl transition-all duration-300 bg-white/10",
            "hover:scale-105 hover:shadow-xl sm:hover:shadow-3xl animate-fade-in-delayed-more",
        ...
        >
          {weatherIcon && (
            <div className="relative">
              ...
              <img
                src={weatherIcon}
                alt="weather"
                className="relative w-15 h-15 sm:w-20 sm:h-20 drop-shadow-lg filter brightness-110 animate-float"
              />
            </div>
          )}
          ...
          <span
            className={clsx(
              "text-2xl sm:text-6xl font-black tracking-tight",
